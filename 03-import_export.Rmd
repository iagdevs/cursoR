...
***
<span style="color:red">**Exercício**: Crie um data frame dos dados de Paracatu com a data no formato `POSIXct` e os resíduos de temperatura, umidade e pressão. Em geral, qual grandeza tem maior resíduo?</span>  
...
O pacote `ncdf4` pode ser usado para acessar essa biblioteca, os comandos abaixo instalam e carregam esse pacote:
...
```{r, eval=F}
edgar <- nc_open(filename = "~/Downloads/v431_v2_REFERENCE_CO_2010_10_AGR.0.1x0.1.nc")
```
