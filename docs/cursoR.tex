...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\OperatorTok{$}\NormalTok{tempo <-}\StringTok{ }\KeywordTok{as.POSIXct}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ df}\OperatorTok{$}\NormalTok{tempo_char, }\DataTypeTok{tz =} \StringTok{"America/Sao_Paulo"}\NormalTok{, }
...
\includegraphics{cursoR_files/figure-latex/unnamed-chunk-90-2.pdf}
...
\includegraphics{cursoR_files/figure-latex/unnamed-chunk-90-3.pdf}
...
\includegraphics{cursoR_files/figure-latex/unnamed-chunk-100-1.pdf}
